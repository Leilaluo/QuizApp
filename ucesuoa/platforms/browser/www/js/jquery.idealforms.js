...
$.idealforms.errors = {
  ...
  number: 'This has to be numbers.',
  digits: 'It must be the unique number.',
  name: 'It must be at least 3 characters long and only contain letters.',
  username: 'It must be between 4 and 32 characters long and start with the letter.',
  pass: 'It must be at least 6 characters long and contain at least one digit, one uppercase letter and one lowercase letter.',
  strongpass: 'It must be at least 8 characters long, containing at least one uppercase letter and one lowercase letter and one digit or special character.',
  email: 'It must be a valid e -mail address. <em>(e.g. user@gmail.com)</em>',
